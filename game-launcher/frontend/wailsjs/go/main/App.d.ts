...
export function CheckLauncherUpdate():Promise<main.LauncherUpdate>;
...
export function FindMissingGames():Promise<Array<main.MissingGame>>;
...
export function OpenLauncherReleasePage():Promise<void>;
...
export function SelectRelinkFolder(arg1:string):Promise<string>;
